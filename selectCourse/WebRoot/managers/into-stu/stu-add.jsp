...
<body leftmargin="50px" topmargin="20px">
	...
	<form action="stuadd" method="post">
		<table border="5"  cellpadding="8px"
			...
			<tr>
				<td>班级</td>
				<td><input type="text" name="banji" id="banji" onblur="banjifun();">
				</td>
				<td><font id="banjiCheck" style="color: #ff9bcd"></font></td>
			</tr>
			<tr>
				<td>籍贯</td>
				<td><input type="text" name="home"  id="home"  onblur="homefun();">
				</td>
				<td><font id="homeCheck" style="color: #ff9bcd"></font></td>
			</tr>
			<tr>
				<td>邮箱</td>
				<td><input type="text" name="email"  id="ma" onblur="emailfun();" />
				</td>
