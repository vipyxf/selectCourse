...
function namefun(){
  ...
  <body leftmargin="50px" topmargin="20px">
	<h2>添加课程信息</h2>
	<form action="couUpbefore" method="post">
		<table border="5"  cellpadding="8px"
			style="border-style:dotted;margin-left:10px;order-color: olive;font-family: '隶书'; font-size:24px;"
			cellspacing="0">
			<%
			Course c=(Course)request.getAttribute("cou");
			 %>
			<tr>
				<td>课程号</td>
				<td><input type="text" name="id" id="id" onblur="AjaxId()" value="<%=c.getCid() %>">
				</td>
				<td><font id="idCheck" style="color:red"></font></td>
			</tr>
			<tr>
				<td>课程名</td>
				<td><input type="text" name="name" id="name" onblur="namefun();" value="<%=c.getCname() %>">
				</td>
				<td><font id="nameCheck" style="color: #ff9bcd"></font></td>
			</tr>
			<tr>
				<td>课程类别</td>
				<td><input type="text" name="type" id="type" onblur="typefun();" value="<%=c.getType() %>">
				</td>
				<td><font id="typeCheck" style="color: #ff9bcd"></font></td>
			</tr>
			<tr>
				<td>学分</td>
				<td><input type="text" name="credit"  id="credit"  onblur="creditfun();" value="<%=c.getCredit() %>">
				</td>
				<td><font id="creditCheck" style="color: #ff9bcd"></font></td>
			</tr>
			<tr>
				<td>教师号</td>
				<td><input type="text" name="tid"  id="tid"  onblur="AjaxTId()" value="<%=c.getTid() %>">
				</td>
