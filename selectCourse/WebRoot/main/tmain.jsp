...
<script charset="utf-8" type="text/javascript"
   ...
   <font id="Clock"
      ...
      align=center>&nbsp;
		...
		<div class="rightNav">
	<a href="./teachers/teaper-info.jsp" style="left: -110px;" target="y">查看个人信息<em>0</em></a>
	<a href="./teachers/update-pwd.jsp" style="left: -110px;"  target="y">修改个人密码<em>1</em></a>
	<a href="teasco" style="left: -110px;"  target="y">修改学生成绩<em>2</em></a>
	<a href="http://sc.chinaz.com" style="left: -110px;"  target="y">课程信息<em>3</em></a>
	<a href="http://sc.chinaz.com" style="left: -110px;"  target="y">教师教案<em>4</em></a>
